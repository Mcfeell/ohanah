			...
			<td class="part-left">
				...
				<div id="ohanah-enable-mail-frontend-enabled-div">			
					<div class="sendmail-container">
						...
						<?=@text('OHANAH_SNIPPETS_YOU_CAN_USE');?>: {NAME} {EMAIL} {EVENT_TITLE} {EVENT_LINK}
				...
				<div id="ohanah-enable-mail-new-registration-enabled-div">			
					<div class="sendmail-container">
						...
						<?=@text('OHANAH_SNIPPETS_YOU_CAN_USE')?>: {NAME} {EMAIL} {EVENT_TITLE} {EVENT_LINK} {TICKETS} {NOTES}
				...
				<div>
					...
					<table>
						<tr>
							...
							<input type="text" id="destination_email" name="destination_email" class="text validate-email" value="<?=$default?>" />
						</tr>
					</table>
				</div>
