	...
	<div class="thirty">
		...
		<div class="dropdownWrapper" style="float:left">
			<div class="dropdown size1">
				...
				<?=@helper('com://admin/ohanah.template.helper.listbox.module_positions', array('name' => 'singleEventModulePosition1', 'selected' => $default)) ?>
			</div>
		</div>
	</div>
	<div class="thirty">
		...
		<div class="dropdownWrapper" style="float:left">
			<div class="dropdown size1">
				...
				<?=@helper('com://admin/ohanah.template.helper.listbox.module_positions', array('name' => 'singleEventModulePosition2', 'selected' => $default)) ?>
			</div>
		</div>
	</div>
	<div class="thirty">
		...
		<div class="dropdownWrapper" style="float:left">
			<div class="dropdown size1">
				...
				<?=@helper('com://admin/ohanah.template.helper.listbox.module_positions', array('name' => 'singleEventModulePosition3', 'selected' => $default)) ?>
			</div>
		</div>
	</div>
	...
	<div class="thirty">
		...
		<div class="dropdownWrapper" style="float:left">
			<div class="dropdown size1">
				...
				<?=@helper('com://admin/ohanah.template.helper.listbox.module_positions', array('name' => 'listEventsModulePosition1', 'selected' => $default)) ?>
			</div>
		</div>
	</div>
	<div class="thirty">
		...
		<div class="dropdownWrapper" style="float:left">
			<div class="dropdown size1">
				...
				<?=@helper('com://admin/ohanah.template.helper.listbox.module_positions', array('name' => 'listEventsModulePosition2', 'selected' => $default)) ?>
			</div>
		</div>
	</div>
	<div class="thirty">
		...
		<div class="dropdownWrapper" style="float:left">
			<div class="dropdown size1">
				...
				<?=@helper('com://admin/ohanah.template.helper.listbox.module_positions', array('name' => 'listEventsModulePosition3', 'selected' => $default)) ?>
			</div>
		</div>
	</div>
	...
	<div class="thirty">
		...
		<div class="dropdownWrapper" style="float:left">
			<div class="dropdown size1">
				...
				<?=@helper('com://admin/ohanah.template.helper.listbox.module_positions', array('name' => 'singleVenueModulePosition1', 'selected' => $default)) ?>
			</div>
		</div>
	</div>
	<div class="thirty">
		...
		<div class="dropdownWrapper" style="float:left">
			<div class="dropdown size1">
				...
				<?=@helper('com://admin/ohanah.template.helper.listbox.module_positions', array('name' => 'singleVenueModulePosition2', 'selected' => $default)) ?>
			</div>
		</div>
	</div>
	<div class="thirty">
		...
		<div class="dropdownWrapper" style="float:left">
			<div class="dropdown size1">
				...
				<?=@helper('com://admin/ohanah.template.helper.listbox.module_positions', array('name' => 'singleVenueModulePosition3', 'selected' => $default)) ?>
			</div>
		</div>
	</div>
	...
	<div class="thirty">
		...
		<div class="dropdownWrapper" style="float:left">
			<div class="dropdown size1">
				...
				<?=@helper('com://admin/ohanah.template.helper.listbox.module_positions', array('name' => 'singleCategoryModulePosition1', 'selected' => $default)) ?>
			</div>
		</div>
	</div>
	<div class="thirty">
		...
		<div class="dropdownWrapper" style="float:left">
			<div class="dropdown size1">
				...
				<?=@helper('com://admin/ohanah.template.helper.listbox.module_positions', array('name' => 'singleCategoryModulePosition2', 'selected' => $default)) ?>
			</div>
		</div>
	</div>
	<div class="thirty">
		...
		<div class="dropdownWrapper" style="float:left">
			<div class="dropdown size1">
				...
				<?=@helper('com://admin/ohanah.template.helper.listbox.module_positions', array('name' => 'singleCategoryModulePosition3', 'selected' => $default)) ?>
			</div>
		</div>
	</div>
	...
	<div class="thirty">
		...
		<div class="dropdownWrapper" style="float:left">
			<div class="dropdown size1">
				...
				<?=@helper('com://admin/ohanah.template.helper.listbox.module_positions', array('name' => 'eventRegistrationModulePosition1', 'selected' => $default)) ?>
			</div>
		</div>
	</div>
	<div class="thirty">
		...
		<div class="dropdownWrapper" style="float:left">
			<div class="dropdown size1">
				...
				<?=@helper('com://admin/ohanah.template.helper.listbox.module_positions', array('name' => 'eventRegistrationModulePosition2', 'selected' => $default)) ?>
			</div>
		</div>
	</div>
	<div class="thirty">
		...
		<div class="dropdownWrapper" style="float:left">
			<div class="dropdown size1">
				...
				<?=@helper('com://admin/ohanah.template.helper.listbox.module_positions', array('name' => 'eventRegistrationModulePosition3', 'selected' => $default)) ?>
			</div>
		</div>
	</div>
